package chisel4ml.simulator
// Code taken from: https://github.com/rameloni/tywaves-chisel.git
...
/** [[TraceVcd]] is an abstracted representation of the [[verilator.Backend.CompilationSettings.TraceStyle.Vcd]] that
  * can be used by the user of the simulator.
  */
...
/** [[SaveWorkspace]] tells to save the workspace of the simulation and stores the final name.
  */
...
/** Package object to expose the simulator settings to the user. The following settings can be used by a simulator to
  * allow users to configure the simulation.
  */
